...
st.write("Welcome to FABIA! I’m here to help you plan and refine your app idea.")

# Add Groq API key input in the sidebar
groq_api_key = st.sidebar.text_input("Enter your Groq API Key:", type="password")
if not groq_api_key:
    st.sidebar.write("Don't have a Groq API key? Get it from [GroqCloud](https://groq.com/).")
...
if user_input and groq_api_key:
    ...
    import requests
    backend_url = "https://fabia-backend.onrender.com/chat"  # Replace with your Render backend URL
